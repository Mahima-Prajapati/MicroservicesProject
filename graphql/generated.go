...
func (ec *executionContext) field_Query_accounts_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "pagination", ec.unmarshalNPaginationInput2githubᚗcomᚋMahimaᚑPrajapatiᚋMicroservicesProjectᚋgraphqlᚐPaginationInput)
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) unmarshalNPaginationInput2githubᚗcomᚋMahimaᚑPrajapatiᚋMicroservicesProjectᚋgraphqlᚐPaginationInput(ctx context.Context, v any) (PaginationInput, error) {
